...
/*! hungrier 2013-08-17 */
!function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z={}.hasOwnProperty,A=function(a,b){function c(){this.constructor=a}for(var d in b)z.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a};Date.prototype.getDayName=function(){return["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][this.getDay()]},Date.prototype.formatDate=function(){var a,b,c;return a=this.getDate(),b=this.getMonth()+1,c=this.getFullYear(),10>a&&(a="0"+a),10>b&&(b="0"+b),""+c+"-"+b+"-"+a},m=function(a,b){return{date:a.formatDate(),day:a.getDayName(),type:b}},p=m(new Date,"today"),i=864e5,q=m(new Date((new Date).getTime()+i),"tomorrow"),n=function(a,b){return"http://food.cs50.net/api/1.3/menus?meal="+b+"&sdt="+a+"&output=jsonp&callback=?"},p={date:"2013-05-02",day:"wednesday",type:"today"},q={date:"2013-05-03",day:"thursday",type:"tomorrow"},l=function(a,b){var c;return c=_.extend({meal:b},a),c.url=n(a.date,b),c},h=[l(p,"lunch"),l(p,"dinner"),l(q,"lunch")],c=function(a){function b(){return r=b.__super__.constructor.apply(this,arguments)}return A(b,a),b}(Backbone.Model),d=function(a){function b(){return s=b.__super__.constructor.apply(this,arguments)}return A(b,a),b}(Backbone.Model),j=function(a){function b(){return t=b.__super__.constructor.apply(this,arguments)}return A(b,a),b.prototype.model=d,b.prototype.createEntreeList=function(a){var b,e;return e=_.extend({},a),e.entrees=_.map(e.entrees,function(a){return new c(a)}),b=new d(e)},b.prototype.fetch=function(){var a,b;return a=this,b=_.map(h,function(a){return $.getJSON(a.url)}),$.when.apply($,b).then(function(){var b,c,d,e,f;for(d=_.map(arguments,_.first),c=_.map(d,function(a){var b;return b={},b.entrees=_.chain(a).map(function(a){return _.chain(a).pick(["meal","date","name","category"]).value()}).filter(function(a){return-1!==a.category.indexOf("ENTREE")||"BRUNCH"===a.category}).value(),b.meal=b.entrees[0].meal,b}),b=e=0,f=c.length-1;f>=0?f>=e:e>=f;b=f>=0?++e:--e)c[b]=_.extend(c[b],h[b]);return a.reset(_.map(c,function(b){return a.createEntreeList(b)}))},function(a){return console.error(a)})},b}(Backbone.Collection),f=function(a){function b(){return u=b.__super__.constructor.apply(this,arguments)}return A(b,a),b.prototype.tagName="li",b.prototype.template="#entree-item",b}(Marionette.ItemView),e=function(a){function b(){return v=b.__super__.constructor.apply(this,arguments)}return A(b,a),b.prototype.className="meal-menu",b.prototype.template="#meal-menu",b.prototype.itemView=f,b.prototype.itemViewContainer="ul",b.prototype.initialize=function(){return this.collection=new Backbone.Collection(this.model.get("entrees"))},b}(Marionette.CompositeView),b=function(a){function b(){return w=b.__super__.constructor.apply(this,arguments)}return A(b,a),b.prototype.tagName="div",b.prototype.template="#empty-menu",b.prototype.initialize=function(){return console.log("empty")},b}(Marionette.ItemView),k=function(a){function c(){return x=c.__super__.constructor.apply(this,arguments)}return A(c,a),c.prototype.itemView=e,c.prototype.itemViewContainer="div",c.prototype.emptyView=b,c.prototype.initialize=function(){return console.log(this.model)},c}(Marionette.CollectionView),g=function(a){function b(){return y=b.__super__.constructor.apply(this,arguments)}return A(b,a),b.prototype.template="#footer",b.prototype.className="footer",b.prototype.events={"click #subscription-toggle":function(a){return a.preventDefault(),this.$("#subscription-info").animate({height:"toggle",opacity:"toggle"})}},b.prototype.onRender=function(){var a;return a=.4,this.$el.fadeTo(300,a),this.$el.hover(function(){return $(this).fadeTo(300,1)},function(){return $(this).fadeTo(300,a)})},b}(Marionette.ItemView),a=new Marionette.Application,a.addRegions({mainRegion:"#food-menu",footerRegion:"#footer-region"}),o=function(a){return this.$el.hide(),this.$el.html(a.el),this.$el.fadeIn(800)},a.mainRegion.open=o,a.footerRegion.open=o,a.addInitializer(function(){var b;return b=new j,b.fetch(),b.on("reset",function(){var b;return b=new k({collection:this}),a.mainRegion.show(b)}),a.footerRegion.show(new g)}),a.start()}.call(this);