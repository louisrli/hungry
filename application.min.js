...
/*! hungrier 2015-03-01 */
(function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,A,B,C,D={}.hasOwnProperty,E=function(a,b){function c(){this.constructor=a}for(var d in b)D.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a},F=[].indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(b in this&&this[b]===a)return b;return-1};Date.prototype.getDayName=function(){return["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][this.getDay()]},Date.prototype.formatDate=function(){var a,b,c;return a=this.getDate(),b=this.getMonth()+1,c=this.getFullYear(),10>a&&(a="0"+a),10>b&&(b="0"+b),""+c+"-"+b+"-"+a},q=function(a,b){return{date:a.formatDate(),day:a.getDayName(),type:b}},t=q(new Date,"today"),k=864e5,u=q(new Date((new Date).getTime()+k),"tomorrow"),a="a1ba99910ddd9ed75bc9a48a440b1906",r=function(b,c){return"http://api.cs50.net/food/3/menus?key="+a+"&meal="+c+"&sdt="+b+"&output=jsonp&callback=?"},p=!1,p&&(t={date:"2013-05-02",day:"wednesday",type:"today"},u={date:"2013-05-03",day:"thursday",type:"tomorrow"}),o=function(a,b){var c;return c=_.extend({meal:b},a),c.url=r(a.date,b),c},n=function(a){return"sunday"===a.toLowerCase()?"brunch":"lunch"},j=[o(t,n(t.day)),o(t,"dinner"),o(u,n(u.day))],c=["Grapefruit","Cage-Free Egg Whites","Shredded Hashbrowns","Zucchini Walnut Bread","Stir Fry Vegetables","Harvard Fruit Salad","Assorted Bagels","Whole Wheat Blueberry Muffin","Smoked Salmon Platter","Carrot, Walnut Cake with Cream Cheese Icing","Scrambled Cage Free Eggs","Turkey Bacon","Hard Cooked Eggs - Cage Free","Cage Free Eggs Cooked to Order","Triple Berry Tea Bread","Whole Wheat Banana Nut Muffin"],e=function(a){function b(){return v=b.__super__.constructor.apply(this,arguments)}return E(b,a),b}(Backbone.Model),f=function(a){function b(){return w=b.__super__.constructor.apply(this,arguments)}return E(b,a),b}(Backbone.Model),l=function(a){function b(){return x=b.__super__.constructor.apply(this,arguments)}return E(b,a),b.prototype.model=f,b.prototype.createEntreeList=function(a){var b,c;return c=_.extend({},a),c.entrees=_.map(c.entrees,function(a){return new e(a)}),b=new f(c)},b.prototype.fetch=function(){var a,b;return a=this,b=_.map(j,function(a){return $.getJSON(a.url)}),$.when.apply($,b).then(function(){var b,d,e,f,g;for(e=_.map(arguments,_.first),d=_.map(e,function(a){var b;return b={},b.entrees=_.chain(a).map(function(a){return _.chain(a).pick(["meal","date","name","category"]).value()}).filter(function(a){var b;return-1!==a.category.indexOf("ENTREE")&&!("ENTREE SALADS"===a.category)||"BRUNCH"===a.category&&(b=a.name,!(F.call(c,b)>=0))||"TODAY\\'S SOUP"===a.category}).value(),b}),b=f=0,g=d.length-1;g>=0?g>=f:f>=g;b=g>=0?++f:--f)d[b]=_.extend(d[b],j[b]);return a.reset(_.map(d,function(b){return a.createEntreeList(b)}))},function(a){return console.error(a)})},b}(Backbone.Collection),h=function(a){function b(){return y=b.__super__.constructor.apply(this,arguments)}return E(b,a),b.prototype.tagName="li",b.prototype.template="#entree-item",b}(Marionette.ItemView),g=function(a){function b(){return z=b.__super__.constructor.apply(this,arguments)}return E(b,a),b.prototype.className="meal-menu",b.prototype.template="#meal-menu",b.prototype.itemView=h,b.prototype.itemViewContainer="ul",b.prototype.initialize=function(){return this.collection=new Backbone.Collection(this.model.get("entrees"))},b}(Marionette.CompositeView),d=function(a){function b(){return A=b.__super__.constructor.apply(this,arguments)}return E(b,a),b.prototype.tagName="div",b.prototype.className="empty-message",b.prototype.template="#empty-menu",b}(Marionette.ItemView),m=function(a){function b(){return B=b.__super__.constructor.apply(this,arguments)}return E(b,a),b.prototype.itemView=g,b.prototype.itemViewContainer="div",b.prototype.emptyView=d,b}(Marionette.CollectionView),i=function(a){function b(){return C=b.__super__.constructor.apply(this,arguments)}return E(b,a),b.prototype.template="#footer",b.prototype.className="footer",b.prototype.events={"click #subscription-toggle":function(a){return a.preventDefault(),this.$("#subscription-info").animate({height:"toggle",opacity:"toggle"})}},b.prototype.onRender=function(){var a;return a=.4,this.$el.fadeTo(300,a),this.$el.hover(function(){return $(this).fadeTo(300,1)},function(){return $(this).fadeTo(300,a)})},b}(Marionette.ItemView),b=new Marionette.Application,b.addRegions({mainRegion:"#food-menu",footerRegion:"#footer-region"}),s=function(a){return this.$el.hide(),this.$el.html(a.el),this.$el.fadeIn(800)},b.mainRegion.open=s,b.footerRegion.open=s,b.addInitializer(function(){var a;return a=new l,a.fetch().then(function(){var c;return c=new m({collection:a}),b.mainRegion.show(a.every(function(a){return 0===a.get("entrees").length})?new d:c)}),b.footerRegion.show(new i)}),b.start()}).call(this);