...
/*! hungrier 2015-02-14 */
(function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,A,B,C={}.hasOwnProperty,D=function(a,b){function c(){this.constructor=a}for(var d in b)C.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a},E=[].indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(b in this&&this[b]===a)return b;return-1};Date.prototype.getDayName=function(){return["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][this.getDay()]},Date.prototype.formatDate=function(){var a,b,c;return a=this.getDate(),b=this.getMonth()+1,c=this.getFullYear(),10>a&&(a="0"+a),10>b&&(b="0"+b),""+c+"-"+b+"-"+a},p=function(a,b){return{date:a.formatDate(),day:a.getDayName(),type:b}},s=p(new Date,"today"),j=864e5,t=p(new Date((new Date).getTime()+j),"tomorrow"),q=function(a,b){return"http://food.cs50.net/api/1.3/menus?meal="+b+"&sdt="+a+"&output=jsonp&callback=?"},o=!1,o&&(s={date:"2013-05-02",day:"wednesday",type:"today"},t={date:"2013-05-03",day:"thursday",type:"tomorrow"}),n=function(a,b){var c;return c=_.extend({meal:b},a),c.url=q(a.date,b),c},m=function(a){return"sunday"===a.toLowerCase()?"brunch":"lunch"},i=[n(s,m(s.day)),n(s,"dinner"),n(t,m(t.day))],b=["Grapefruit","Cage-Free Egg Whites","Shredded Hashbrowns","Zucchini Walnut Bread","Stir Fry Vegetables","Harvard Fruit Salad","Assorted Bagels","Whole Wheat Blueberry Muffin","Smoked Salmon Platter","Carrot, Walnut Cake with Cream Cheese Icing","Scrambled Cage Free Eggs","Turkey Bacon","Hard Cooked Eggs - Cage Free","Cage Free Eggs Cooked to Order","Triple Berry Tea Bread","Whole Wheat Banana Nut Muffin"],d=function(a){function b(){return u=b.__super__.constructor.apply(this,arguments)}return D(b,a),b}(Backbone.Model),e=function(a){function b(){return v=b.__super__.constructor.apply(this,arguments)}return D(b,a),b}(Backbone.Model),k=function(a){function c(){return w=c.__super__.constructor.apply(this,arguments)}return D(c,a),c.prototype.model=e,c.prototype.createEntreeList=function(a){var b,c;return c=_.extend({},a),c.entrees=_.map(c.entrees,function(a){return new d(a)}),b=new e(c)},c.prototype.fetch=function(){var a,c;return a=this,c=_.map(i,function(a){return $.getJSON(a.url)}),$.when.apply($,c).then(function(){var c,d,e,f,g;for(e=_.map(arguments,_.first),d=_.map(e,function(a){var c;return c={},c.entrees=_.chain(a).map(function(a){return _.chain(a).pick(["meal","date","name","category"]).value()}).filter(function(a){var c;return-1!==a.category.indexOf("ENTREE")&&!("ENTREE SALADS"===a.category)||"BRUNCH"===a.category&&(c=a.name,!(E.call(b,c)>=0))||"TODAY'S SOUP"===a.category}).value(),c}),c=f=0,g=d.length-1;g>=0?g>=f:f>=g;c=g>=0?++f:--f)d[c]=_.extend(d[c],i[c]);return a.reset(_.map(d,function(b){return a.createEntreeList(b)}))},function(a){return console.error(a)})},c}(Backbone.Collection),g=function(a){function b(){return x=b.__super__.constructor.apply(this,arguments)}return D(b,a),b.prototype.tagName="li",b.prototype.template="#entree-item",b}(Marionette.ItemView),f=function(a){function b(){return y=b.__super__.constructor.apply(this,arguments)}return D(b,a),b.prototype.className="meal-menu",b.prototype.template="#meal-menu",b.prototype.itemView=g,b.prototype.itemViewContainer="ul",b.prototype.initialize=function(){return this.collection=new Backbone.Collection(this.model.get("entrees"))},b}(Marionette.CompositeView),c=function(a){function b(){return z=b.__super__.constructor.apply(this,arguments)}return D(b,a),b.prototype.tagName="div",b.prototype.className="empty-message",b.prototype.template="#empty-menu",b}(Marionette.ItemView),l=function(a){function b(){return A=b.__super__.constructor.apply(this,arguments)}return D(b,a),b.prototype.itemView=f,b.prototype.itemViewContainer="div",b.prototype.emptyView=c,b}(Marionette.CollectionView),h=function(a){function b(){return B=b.__super__.constructor.apply(this,arguments)}return D(b,a),b.prototype.template="#footer",b.prototype.className="footer",b.prototype.events={"click #subscription-toggle":function(a){return a.preventDefault(),this.$("#subscription-info").animate({height:"toggle",opacity:"toggle"})}},b.prototype.onRender=function(){var a;return a=.4,this.$el.fadeTo(300,a),this.$el.hover(function(){return $(this).fadeTo(300,1)},function(){return $(this).fadeTo(300,a)})},b}(Marionette.ItemView),a=new Marionette.Application,a.addRegions({mainRegion:"#food-menu",footerRegion:"#footer-region"}),r=function(a){return this.$el.hide(),this.$el.html(a.el),this.$el.fadeIn(800)},a.mainRegion.open=r,a.footerRegion.open=r,a.addInitializer(function(){var b;return b=new k,b.fetch().then(function(){var d;return d=new l({collection:b}),a.mainRegion.show(b.every(function(a){return 0===a.get("entrees").length})?new c:d)}),a.footerRegion.show(new h)}),a.start()}).call(this);